...
export const PREDEFINED_THEMES: ThemeConfig[] = [
  {
    "id": "cappuccino",
    "name": "Cappuccino",
    "description": "Warm cream tones with handcrafted terracotta accents. (The original hardcoded theme)",
    "colors": {
      "background": "#F5EBDD",
      "surface": "#FFF8ED",
      "primary": "#914C2B",
  ...
  },
  {
    ...
    "shadows": {
      "card": "0 2px 8px rgba(66, 107, 69, 0.05)",
      "floating": "0 10px 20px rgba(66, 107, 69, 0.1)"
    },
    "spacing": {
      "xs": "0.5rem",
      "sm": "1rem",
  ...
  },
  {
    ...
    "shadows": {
      "card": "none",
      "floating": "0 10px 30px rgba(0,0,0,0.05)"
    },
    "spacing": {
      "xs": "0.75rem",
      "sm": "1.5rem",
  ...
  },
  {
    ...
    "shadows": {
      "card": "0 4px 12px rgba(184, 92, 56, 0.08)",
      "floating": "0 12px 24px rgba(184, 92, 56, 0.15)"
    },
    "spacing": {
      "xs": "0.5rem",
      "sm": "1rem",
  ...
  },
  {
    ...
    "shadows": {
      ...
      "floating": "0 10px 25px rgba(0,0,0,0.5), 0 0 15px rgba(46, 139, 203, 0.1)"
    },
    "spacing": {
      "xs": "0.5rem",
      "sm": "1rem",
  ...
  },
  {
    ...
    "shadows": {
      "card": "0 4px 15px rgba(231, 122, 0, 0.08)",
      "floating": "0 12px 30px rgba(231, 122, 0, 0.15)"
    },
    "spacing": {
      "xs": "0.5rem",
      "sm": "1rem",
  ...
  },
  {
    ...
    "shadows": {
      "card": "0 4px 12px rgba(201, 95, 97, 0.05)",
      "floating": "0 12px 25px rgba(201, 95, 97, 0.12)"
    },
    "spacing": {
      "xs": "0.5rem",
      "sm": "1rem",
  ...
  },
  {
    ...
    "shadows": {
      ...
      "floating": "0 10px 30px rgba(0,0,0,0.6)"
    },
    "spacing": {
      "xs": "0.5rem",
      "sm": "1rem",
